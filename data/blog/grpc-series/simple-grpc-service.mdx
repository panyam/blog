...
A small part of the base entity looks like:

The base entity store can be found [here](https://raw.githubusercontent.com/panyam/grpcdemos/PART1/musicservice/services/base.go).

Using this the [song service](https://raw.githubusercontent.com/panyam/grpcdemos/PART1/musicservice/services/songs.go) is very simple.
