...
`grpc_cli --json_input call localhost:9000 CreateSong '{song: {name: "first song"}}'`
...
`grpc_cli --json_input call localhost:9000 CreateSong '{song: {name: "a really cool song"}}'`
...
`grpc_cli call localhost:9000 ListSongs`
...
`grpc_cli --json_input call localhost:9000 GetSongs '{"ids": ["1", "2"]}'`
