...
This ensures that all our "source" folders (cmd, gen, datastore, services) are mounted *into* the docker image as volumes.  This is needed so that Air can find the needed files when it initiates a rebuild.
