...
- We built a simple gRPC service for managing topics and messages in a chat service (like a very simple version of Slack or Teams).
...
```
EMBED Makefile from RESTHTTPGW branch
```
