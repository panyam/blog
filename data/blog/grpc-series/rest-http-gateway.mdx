...
│   │       └── http.proto
├── proto
    └── google -> musicservice/vendors/google
    └── musicservice
        └── v1
            └── songs.proto
            └── albums.proto
...
```
EMBED Makefile from PART2 branch
```
