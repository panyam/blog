...
In [Part 1](/blog/grpc-series/a-simple-grpc-service/):
...
You might have already guessed - protoc plugins again comes to the rescue.  In our service's Makefile (see [Part 1](/blog/grpc-series/a-simple-grpc-service/)), we had generated message and service stubs for Go using the protoc-gen-go plugin:
