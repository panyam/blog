---
title: 'REST/Http gateway for a gRPC service'
...
That was a lot to cover but we made it.   Even though it was a basic example, hope it was worth it and set a good foundation for the topics in upcoming series.   In this (dense) guide we:
